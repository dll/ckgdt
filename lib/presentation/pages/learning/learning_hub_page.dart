      ...
      builder: (context, _) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
              bottom: BorderSide(color: NoirTokens.paper.withOpacity(0.08)),
            ),
          ),
          child: Row(
            children: [
              Icon(Icons.filter_list, size: 16, color: NoirTokens.paper.withOpacity(0.5)),
              ...
              child: Container(
                ...
                child: Center(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(Icons.play_circle_fill, size: 32, color: accent.withOpacity(0.6)),
                      if (isAi) ...[
                        const SizedBox(height: 4),
                        Container(
