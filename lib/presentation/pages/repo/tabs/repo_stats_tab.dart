  ...
  Future<void> _runAudit() async {
    ...
    try {
      final content = await widget.gitee.getFileContent(
          CourseResourceService.sysOwner, CourseResourceService.sysRepo, 'course_config/lab_tasks.json');
    ...
    try {
      final dir = await widget.gitee.listDir(
          CourseResourceService.sysOwner, CourseResourceService.sysRepo, 'course_config');
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFlowItem(
              ...
              title: '系统代码仓库 (${CourseResourceService.sysOwner}/${CourseResourceService.sysRepo})',
