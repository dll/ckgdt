...
class _CollaborationPageState extends State<CollaborationPage>
    ...
    try {
      ...
      for (int i = 0; i < repoMembers.length; i++) {
        ...
        subs.add({
          ...
          'description': m['features'] as String? ?? '课程项目',
        });
      }
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [
            ...
            Tab(icon: Icon(Icons.assignment_ind, size: 20), text: '分工管理'),
            Tab(icon: Icon(Icons.rate_review, size: 20), text: '互评中心'),
          ],
        ),
      ),
      body: _isLoading
  ...
  String _formatTime(String isoString) {
    ...
    try {
      ...
      swallowDebug(e, tag: 'collaboration_page._formatTime', stack: st);
