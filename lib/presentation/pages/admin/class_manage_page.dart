...
class _ClassManagePageState extends State<ClassManagePage>
  ...
  Widget _buildClassCard(
    ...
    final cardColor =
        isArchived ? Colors.grey.withOpacity(0.06) : theme.cardColor;
  ...
  String _formatDate(String isoString) {
    try {
      ...
      swallowDebug(e, tag: 'ClassManagePage.formatDate', stack: st);
      return isoString;
    }
  }
}
...
class _ClassMemberSheetState extends State<_ClassMemberSheet> {
  ...
  String _formatShortDate(String isoString) {
    try {
      ...
      swallowDebug(e, tag: 'ClassManagePage.formatShortDate', stack: st);
      return '';
    }
  }
}
