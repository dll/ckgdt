...
''';
      case 'teacher_guide':
      case 'student_guide':
        return '请结合当前课程章节、实践任务、学习要求和考核方式，重新整理指导手册正文。';
      default:
...
## 一、统计口径
本表统计期中前已布置的课后作业、阶段测验、实践报告、项目阶段材料及其批阅反馈情况。
