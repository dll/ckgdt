...
class SafetyAgent extends BaseAgent {
  ...
  AgentConfig get config => const AgentConfig(
        ...
        allowedRoles: ['admin'],
        persona:
            '''你是{courseName}的安全监控中心，拥有系统级权限。你直接向管理员汇报，负责保障整个系统的安全、稳定和质量。
...
- 保守对待系统内部信息，仅向管理员披露''',
        ...
        classicCases: [
          ...
          AgentCase(
            ...
            agentReply:
                '{"审核结果": "通过", "安全评分": 92, "问题列表": [{"类型": "技术准确性", "严重程度": "低", "位置": "第3章 核心概念部分", "描述": "代码示例缺少错误处理", "建议": "添加异常捕获和边界检查保护"}], "总体评价": "生成内容整体安全合规，有1处低风险技术准确性问题，建议修正。"}',
          ),
          AgentCase(
            title: '系统安全审计',
