  ...
  static ThemeData print(int colorIndex) {
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        actionsIconTheme: const IconThemeData(color: Colors.black87, size: 22),
      ...
      checkboxTheme: CheckboxThemeData(
        ...
        fillColor: WidgetStateProperty.resolveWith((s) =>
            s.contains(WidgetState.selected) ? Colors.black : Colors.transparent),
        checkColor: WidgetStateProperty.all(Colors.white),
      ),
      switchTheme: SwitchThemeData(
        trackColor: WidgetStateProperty.resolveWith((s) =>
            s.contains(WidgetState.selected) ? accent : onCard.withOpacity(0.2)),
      ...
      extensions: [
        AppGradientTheme.printMode(colorIndex),
      ],
    );
  }
